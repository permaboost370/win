...
const PROMPT =
  "Restyle the person in the first image into the same clean cartoon illustration style as the second reference image. Give them long swept-back bright blonde hair and black wayfarer-style sunglasses exactly matching the second reference image. Dress them in a dark navy suit, white shirt, and red tie matching the reference. Plain white background. Keep the original person's facial structure, identity, and expression so they remain recognizable. Match the second image's bold linework, cel-shaded coloring, and overall art style. Square portrait suitable as a profile picture.";
