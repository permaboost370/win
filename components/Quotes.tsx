...
export default function Quotes() {
  return (
    <section id="quotes" className="relative bg-bone text-ink">
      <div className="mx-auto max-w-7xl px-4 sm:px-8 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
          <figure className="group border-4 border-ink bg-bone shadow-[10px_10px_0_0_#e81d1d] plate">
          ...
          <figure className="group border-4 border-ink bg-bone shadow-[10px_10px_0_0_#050505] plate">
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image
                src="/img2.jpg"
